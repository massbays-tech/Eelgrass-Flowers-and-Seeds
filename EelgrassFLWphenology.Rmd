...
##EG 2024
```{r}
d.flw.stage.2024 <- read.csv("C:/Users/Forest.Schenck/Downloads/whoi.eelgrass.flw.stage.data.csv")

d.flw.den.2024 <- read.csv("C:/Users/Forest.Schenck/Downloads/whoi.eelgrass.density.data.csv")
...
```{r}
d.t.AQ <- read.csv("C:/Users/Forest.Schenck/Downloads/21177827_AQ.csv")

d.t.CB <- read.csv("C:/Users/Forest.Schenck/Downloads/21258498_CB.csv")

d.t.CI <- read.csv("C:/Users/Forest.Schenck/Downloads/20536645_CI.csv")

d.t.PC <- read.csv("C:/Users/Forest.Schenck/Downloads/21177829_PC.csv")

d.t.DC <- read.csv("C:/Users/Forest.Schenck/Downloads/21258490_DC.csv")

d.t.LH <- read.csv("C:/Users/Forest.Schenck/Downloads/10942817_LH.csv")

d.t.SH <- read.csv("C:/Users/Forest.Schenck/Downloads/21177828_SH.csv")
